...
--run_id_note VLA-Adapter-SF-DIST_LAYR-18--libero_spatial_no_noops--$current_time \
> logs/VLA-Adapter-SF-DIST_LAYR-18--libero_spatial_no_noops--$current_time.log 2>&1 & 
